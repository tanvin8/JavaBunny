    ...
    <div className="p-[150px] bg-champagne font-quicksand py-[70px]">
      ...
      <div className="text-left font-bold text-golden space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { id: '6-1', title: '6.1: Why Use Loops?', desc: 'Understand why repeating code is useful and efficient.' },
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { id: '7-1', title: '7.1: What is a Method?', desc: 'Understand why methods help you organize and reuse code.' },
